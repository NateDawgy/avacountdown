/*
   ...
   A few things complicate the implementation of this watch:
      ...
      generate and use images instead of
...
#define MY_UUID {0x62, 0xC4, 0x91, 0x46, 0xB0, 0xF3, 0x44, 0x35, 0x87, 0xAE, 0x59, 0x13, 0x24, 0x3F, 0x60, 0x37}
PBL_APP_INFO(MY_UUID, "Ava Countdown", "Natedawgyapps", 0x5, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
